...
# running arguments
data_path = r"/Users/aki/Downloads/OCR/final/sample"
results_path = r"/Users/aki/Downloads/OCR/final/cutouts"
plot_results_path = r"/Users/aki/Downloads/OCR/final/plots"
exception_images = r"/Users/aki/Downloads/OCR/final/exception"
txt_results_path = r"/Users/aki/Downloads/OCR/final/txts"
# tesseract_installed_path = r'C:\Program Files\Tesseract-OCR\tesseract.exe'
...
for img_name in tqdm(sorted(os.listdir(data_path))):
    ...
    try:
        ...
        if os.path.isdir(cutouts_save_path):                 #aki - to delete folder if exist
            shutil.rmtree(cutouts_save_path)
        ...
        # convert splited image into text files:
        for splits in sorted(os.listdir(cutouts_save_path)):
            if 'column_' in splits or 'cutout_' in splits:
